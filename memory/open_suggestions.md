...
> آخر تحديث: 2026-08-04 (روتين صباحي — الثلاثاء | يوم 79 نظيف ← رقم قياسي مستمر 🎉 | [A][B] 80 يوم ← رقم قياسي | [C] 84 يوم ← الأقدم | يوم 30 حي [G] 🎯 — **القرار اليوم** | يوم 31 حي [F] — القرار ~2026-08-07 | يوم 19 حي [I] | CPI متأخر **21 يوم** 🔴🔴🔴)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20)* ⚡⚡⚡ ESCALATED CRITICAL — ينتظر موافقتك منذ **80 يوم**
...
### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16)* 🚨🚨🚨 CRITICAL — ينتظر موافقتك منذ **80 يوم**
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12)* ← الأقدم في تاريخ البوت كله — **84 يوم**
...
- **الحالة:** 🔴🔴🔴 **متأخر 21 يوماً — الأعلى في تاريخ البوت — السوق مفتوح الآن (الثلاثاء) — يحتاج تحديثاً فورياً على VPS**

### [G] ✅ GBPUSD — H4 RSI Filter *(مطبَّق 2026-07-05)* — يوم 30 حي 🎯 — **القرار اليوم**
- **النتيجة (backtest):** Sharpe 1.273 → 1.664 (+0.391)
- **الحالة:** مرحلة التأكيد الحرجة — **يوم القرار 2026-08-04** — راجع صفقات GBPUSD على VPS فوراً
- **معيار القرار:** إذا Win Rate ≥ 40% على ≥ 15 صفقة → ✅ ابقِ الفلتر | إذا أسوأ → ❌ ارجع Baseline

### [F] ✅ USDJPY BOJ Filter *(مطبَّق 2026-07-04)* — يوم 31 حي — ما بعد BOJ
- **النتيجة (backtest):** Sharpe 0.97 → 1.58 (+0.61)
- **BOJ 31 يوليو:** مرّ (3 أيام) — الإعلان صدر 01:00-04:00 UTC — لا بيانات VPS متاحة هنا
- **BOJ_LOWER=149:** مُختبَر ومؤكَّد — جاهز لكل السيناريوهات ✅
- **الحالة:** انتظار نتائج VPS — القرار النهائي ~2026-08-07

### [I] ✅ EURUSD ADX_MIN=18 Filter *(مطبَّق 2026-07-16)* — يوم 19 حي (مراقبة مبكرة)
