...
> آخر تحديث: 2026-07-04 (روتين صباحي — السبت | يوم 49 نظيف | 🏆 [F] BOJ Zone Filter مطبَّق! USDJPY Sharpe 0.97→1.58 | [A][B][C] تنتظر الموافقة 49-53 يوم | [CPI Update] ~8 يوليو)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 49 يوم)* ⚡⚡⚡ ESCALATED CRITICAL — **ينتظر موافقتك منذ 49 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**48 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 49 يوم)* 🚨🚨🚨 CRITICAL — **ينتظر موافقتك منذ 49 يوم**
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 53 يوم)* ← الأقدم في تاريخ البوت كله
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**52 يوم** ← **الأقدم في تاريخ البوت كله**)
...
### [G] GBPUSD — H4 RSI Filter *(2026-07-04، جديد)* 🔴 الأولوية الجديدة بعد [F]
- **الخلفية:** GBPUSD الفجوة الوحيدة المتبقية (Sharpe 1.27 vs هدف 1.5 = -0.23)
- **المقترح:** لا دخول عند RSI(14) > 70 أو < 30 على H4 (تجنّب overextended moves)
- **الجدول:** الأحد 5 يوليو 2026 (نافذة صيانة)
- **الأولوية:** 🔴 عالية — آخر زوج تحت الهدف
- **الحالة:** 💡 مقترح جديد — يحتاج backtest
