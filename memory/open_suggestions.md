...
> آخر تحديث: 2026-05-31 (روتين صباحي — الأحد | فتح الأسواق الليلة 23:00 UTC | آخر نافذة صيانة)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 12 أيام)* ⚡⚡⚡ ESCALATED CRITICAL — آخر فرصة قبل فتح الأسواق
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**12 يوم** — **الأسواق تفتح الليلة 23:00 UTC = آخر فرصة الأحد**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 15 يوم)* 🚨🚨 CRITICAL — رقم قياسي — آخر فرصة قبل فتح الأسواق
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**15 يوم** ← **الأسواق تفتح الليلة 23:00 UTC = تطبيق الآن ضروري**)
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 19 يوم)* ← الأقدم في كل السجل
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**19 يوم** ← **الأقدم في كل السجل — آخر فرصة قبل فتح الأسواق**)
...
### [18] فتح الأسواق الليلة + ISM Manufacturing PMI *(2026-05-31، جديد)*
- **الموضوع:** الأسواق تفتح 23:00 UTC الليلة — أول جلسة آسيا للأسبوع
- **ISM Manufacturing PMI:** يصدر غداً الاثنين ~14:00 UTC — محرك USD في جلسة NY
- **الأزواج المتأثرة:** EURUSD/GBPUSD (NY Breakout 13:00-15:00) + XAUUSD
- **التوصية:** تحقق من VPS قبل 23:00 UTC | انتبه لـ ISM قبل دخول NY غداً
- **الحالة:** 🔍 تنبيه يومي
