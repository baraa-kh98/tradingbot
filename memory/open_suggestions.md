...
> آخر تحديث: 2026-05-26 (روتين صباحي — الثلاثاء)

---

## 🟡 متوسطة الأولوية

### [6] XAUUSD — `_regime_check()` Exception بدون Logging *(2026-05-25، يومان)*
...
### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 7 أيام)*
...
### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 10 أيام)*
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**10 أيام** ← يُوصى بالتطبيق مع #4)
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 14 يوم)*
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**14 يوم** ← الأقدم في القائمة)
...
### [15] Core PCE الخميس 28 مايو وتأثيره على البوت *(جديد 2026-05-26)*
...
- **متى نقرر؟:** بعد مراقبة رد فعل السوق الخميس
- **الحالة:** 🔍 تحت المراقبة
