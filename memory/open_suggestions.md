...
> آخر تحديث: 2026-07-14 (روتين صباحي — الاثنين | يوم 58 نظيف | 🔬 [H] EURUSD MACD Filter ❌ REJECTED | 🔴 June CPI اليوم @ 12:30 UTC | [A][B] 59 يوم | [C] 63 يوم ← الأقدم | يوم 9 حي [G] | يوم 10 حي [F])

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20)* ⚡⚡⚡ ESCALATED CRITICAL — **ينتظر موافقتك منذ 59 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**59 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16)* 🚨🚨🚨 CRITICAL — **ينتظر موافقتك منذ 59 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**63 يوم** ← **الأقدم في تاريخ البوت كله**)
...
- **الحالة:** 🔴 **مجدول اليوم الاثنين 14 يوليو — روتين الليلي/المساء يُطبّقه**
...
### [I] EURUSD — ADX Threshold Filter *(جديد 2026-07-14)*
- **الملف:** `strategy/eurusd_signal.py`
- **الفرضية:** بديل [H] المرفوض — رفع ADX_MIN لتصفية السوق الجانبية بدون تحيز اتجاه
- **المقترح:** اختبار ADX_MIN = {20, 22, 25, 28, 30} grid search
- **الهدف:** EURUSD Sharpe 1.61 → 1.75+
- **تاريخ الاكتشاف:** 2026-07-14
- **الحالة:** 💡 جديد — تحتاج Backtest الثلاثاء/الأربعاء
