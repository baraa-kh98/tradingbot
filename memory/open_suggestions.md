...
> آخر تحديث: 2026-06-09 (روتين صباحي — الثلاثاء | أسبوع ما بعد NFP | يوم 24 نظيف ← رقم قياسي مطلق جديد)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 24 يوم)* ⚡⚡⚡ ESCALATED CRITICAL — **ينتظر موافقتك**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**24 يوم** — **ينتظر موافقتك**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 24 يوم)* 🚨🚨🚨 CRITICAL — رقم قياسي مطلق جديد — **ينتظر موافقتك**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**24 يوم** ← رقم قياسي مطلق جديد — **ينتظر موافقتك**)
...
### [19] GBPUSD Docstring قديم *(جديد 2026-06-09)*
- **الملف:** `strategy/gbpusd_signal.py:9-17`
- **المشكلة:** الـ docstring يقول `min_rr=3.0 | TP = 3.0 × risk` لكن القيمة الفعلية `MIN_RR=4.0` (بعد finetune 2026-06-06)
- **التأثير:** لا تأثير وظيفي — مجرد توثيق مضلّل للقراءة
- **الإصلاح:** تحديث السطور 9,12,16 في الـ docstring
- **تاريخ الاكتشاف:** 2026-06-09
- **الحالة:** 📝 منخفضة الأولوية — توثيق فقط

---

### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 28 يوم)* ← الأقدم في تاريخ البوت كله
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**28 يوم** ← **الأقدم في تاريخ البوت كله**)

### [18] USDJPY — استراتيجية بديلة *(جديد 2026-06-07)*
...
- **الأولوية:** متوسطة — بعد XAUUSD finetune
