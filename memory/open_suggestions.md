...
> آخر تحديث: 2026-06-17 (روتين صباحي — الأربعاء | يوم 3 من أسبوع FOMC | ⚠️⚠️⚠️ FOMC TOMORROW 18 يونيو 18:00 UTC | يوم 32 نظيف ← رقم قياسي مطلق جديد)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 32 يوم)* ⚡⚡⚡ ESCALATED CRITICAL — **ينتظر موافقتك**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**32 يوم** — **ينتظر موافقتك**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 32 يوم)* 🚨🚨🚨 CRITICAL — رقم قياسي مطلق جديد — **ينتظر موافقتك**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**32 يوم** ← رقم قياسي مطلق جديد — **ينتظر موافقتك**)
...
### [19] GBPUSD Docstring قديم *(2026-06-09، 9 يوم)*
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 36 يوم)* ← الأقدم في تاريخ البوت كله
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**36 يوم** ← **الأقدم في تاريخ البوت كله**)
...
### [21] FOMC Day Filter لـ EURUSD/GBPUSD *(2026-06-14، 3 يوم)* ← ⚠️⚠️⚠️ FOMC TOMORROW — أول بيانات حقيقية غداً
