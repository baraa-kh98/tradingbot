...
> آخر تحديث: 2026-06-13 (روتين صباحي — السبت | سوق مغلق | يوم 28 نظيف ← رقم قياسي مطلق جديد | gold_finetune: ❌ لا تغيير)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 28 يوم)* ⚡⚡⚡ ESCALATED CRITICAL — **ينتظر موافقتك**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**27 يوم** — **ينتظر موافقتك**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 28 يوم)* 🚨🚨🚨 CRITICAL — رقم قياسي مطلق جديد — **ينتظر موافقتك**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**27 يوم** ← رقم قياسي مطلق جديد — **ينتظر موافقتك**)
...
### [19] GBPUSD Docstring قديم *(2026-06-09، 5 يوم)*
...
- **الاختبار:** تعديل NBAR=20, ADX_MIN=20 في `backtest/xauusd_backtest.py` (30 دقيقة)
