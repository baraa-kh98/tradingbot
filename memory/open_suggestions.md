...
> آخر تحديث: 2026-06-25 (روتين صباحي — الخميس | يوم 40 نظيف ← رقم قياسي مطلق جديد | ما بعد FOMC يوم 7 | ⚠️⚠️ Jobless Claims اليوم 12:30 UTC | [A][B][C][D] لا تزال تنتظر الموافقة | [18] USDJPY backtest السبت 28 يونيو | ⚠️⚠️ Month-End + Q2-End الجمعة 27 يونيو — يومان)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 40 يوم)* ⚡⚡⚡ ESCALATED CRITICAL — **ينتظر موافقتك منذ 40 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**40 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 40 يوم)* 🚨🚨🚨 CRITICAL — **ينتظر موافقتك منذ 40 يوم**
...
### [19] GBPUSD Docstring قديم *(2026-06-09، 17 يوم)*
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 44 يوم)* ← الأقدم في تاريخ البوت كله
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**44 يوم** ← **الأقدم في تاريخ البوت كله**)

### [WEEK] Month-End + Q2-End Risk — غداً الجمعة 27 يونيو *(جديد 2026-06-22)* ⚠️⚠️ تحذير فوري — يومان
...
- **التوصية:** على VPS — لا إشارات جديدة بعد 15:30 UTC الجمعة | NY window (13-15) آمن طبيعياً
- **ملاحظة جديدة:** Q2-End أشد من month-end عادي — صناديق الاستثمار تُعيد توازن بالمليارات
- **الحالة:** 👁️⚠️ تحذير فوري — يومان فقط
