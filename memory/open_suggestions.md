...
> آخر تحديث: 2026-07-31 (روتين صباحي — الجمعة | يوم 75 نظيف ← رقم قياسي مستمر 🎉 | **🚨🚨🚨 BOJ DAY** الإعلان قد صدر | [A][B] 76 يوم ← رقم قياسي | [C] 80 يوم ← الأقدم | يوم 26 حي [G] 🎯 | يوم 27 حي [F] — **⚡ يوم BOJ الحقيقي!** | يوم 15 حي [I] | CPI متأخر **17 يوم** 🔴)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20)* ⚡⚡⚡ ESCALATED CRITICAL — ينتظر موافقتك منذ **76 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**76 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16)* 🚨🚨🚨 CRITICAL — ينتظر موافقتك منذ **76 يوم**
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12)* ← الأقدم في تاريخ البوت كله — **80 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**80 يوم** ← **الأقدم في تاريخ البوت كله**)
...
- **الحالة:** 🔴 **متأخر 17 يوماً — عاجل جداً — BOJ اليوم (31 يوليو) قد يغير real yield — يحتاج تدخل يدوي على VPS اليوم/غداً**

### [G] ✅ GBPUSD — H4 RSI Filter *(مطبَّق 2026-07-05)* — يوم 26 حي 🎯
- **النتيجة (backtest):** Sharpe 1.273 → 1.664 (+0.391)
- **الحالة:** مراقبة مستمرة — مرحلة التأكيد الحرجة (15 صفقة لايف)
- **القرار المتوقع:** ~2026-08-04 (4 أيام إضافية أو 10 صفقات لايف أيهما أول)

### [F] ✅ USDJPY BOJ Filter *(مطبَّق 2026-07-04)* — يوم 27 حي — **🚨🚨🚨 BOJ DAY اليوم! الاختبار الحقيقي الآن**
- **النتيجة (backtest):** Sharpe 0.97 → 1.58 (+0.61)
- **تنبيه:** BOJ اجتماع 31 يوليو — **اليوم الجمعة** — الإعلان 01:00-04:00 UTC قد صدر بالفعل (05:37 UTC الآن)
- **BOJ_LOWER=149:** مُختبَر 2026-07-18 — جاهز لكل السيناريوهات ✅
- **London session اليوم:** تبدأ 07:00 UTC — الفلتر يعمل في بيئة BOJ حرجة — **مراقبة يدوية مطلوبة**

### [I] ✅ EURUSD ADX_MIN=18 Filter *(مطبَّق 2026-07-16)* — يوم 15 حي (مراقبة مبكرة)
...
- **الحالة:** 💡 BOJ اليوم — الأسبوع القادم مناسب للـ backtest (بعد تقييم حركة السوق اليوم)

### [22] XAUUSD BOJ/FOMC Event ± 24h ATR Threshold *(2026-07-26 — جديد)*
...
- **ملاحظة:** BOJ اليوم (31 يوليو) سيعطي بيانات حقيقية — راجع XAUUSD اليوم وقارن ATR مع الأيام العادية
- **الحالة:** 💡 fكرة جديدة — backtest `xauusd_backtest.py` يوم السبت 2026-08-01

### [BOJ Prep] USDJPY BOJ_LOWER طوارئ *(2026-07-31)* — ✅ مُختبَر 2026-07-18 — **🚨 اليوم يوم الإعلان الفعلي**
- **الخطر:** BOJ اجتماع 31 يوليو — **اليوم الجمعة** — إعلان 01:00-04:00 UTC قد صدر بالفعل — إذا رُفعت الفائدة → USDJPY قد يكسر 149
- **الملف:** `strategy/london_signal.py` — BOJ_LOWER=149 حالياً
- **النتيجة:** BOJ_LOWER=149 هو الأفضل — مُختبَر ومؤكَّد — لا تغيير لازم
- **الحالة:** ✅ جاهز تماماً — **مراقبة يدوية مطلوبة اليوم (London 07:00 UTC)** — الإعلان قد صدر بالفعل

### [23] USDJPY Post-BOJ Momentum Strategy *(2026-07-30 — جديد)*
...
- **الشرط:** فقط بعد تأكيد رفع الفائدة (ليس تثبيت)
- **ملاحظة:** بيانات BOJ اليوم ستحدد جدوى هذه الفكرة — راقب USDJPY direction بعد الإعلان
- **الحالة:** 💡 فكرة جديدة — backtest يوم السبت 2026-08-01 مع `USDJPY_H1_2years.csv`
