...
> آخر تحديث: 2026-07-27 (روتين صباحي — الاثنين | يوم 71 نظيف ← رقم قياسي مستمر 🎉 | السوق يفتح اليوم | [A][B] 72 يوم ← رقم قياسي | [C] 76 يوم ← الأقدم | يوم 22 حي [G] 🎯 | يوم 23 حي [F] | يوم 11 حي [I] | BOJ 31 يوليو: 4 أيام 🚨 | CPI متأخر 13 يوم)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20)* ⚡⚡⚡ ESCALATED CRITICAL — ينتظر موافقتك منذ **72 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**72 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16)* 🚨🚨🚨 CRITICAL — ينتظر موافقتك منذ **72 يوم**
...
- **المشكلة:** `_regime_check()` تستدعي yfinance API في كل دورة (كل 15 دقيقة) بدون Cache
  ...
  - Dead Import: `from datetime import timedelta` داخل الدالة لا يُستخدم (L136)
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12)* ← الأقدم في تاريخ البوت كله — **76 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**76 يوم** ← **الأقدم في تاريخ البوت كله**)
...
- **الحالة:** 🔴 **متأخر 13 يوماً — عاجل قبل BOJ 31 يوليو (4 أيام) — يحتاج تدخل يدوي على VPS**

### [G] ✅ GBPUSD — H4 RSI Filter *(مطبَّق 2026-07-05)* — يوم 22 حي 🎯
- **النتيجة (backtest):** Sharpe 1.273 → 1.664 (+0.391)
- **الحالة:** مراقبة مستمرة — مرحلة التأكيد الحرجة (15 صفقة لايف)
- **القرار المتوقع:** ~2026-08-04 (8 أيام إضافية أو 10 صفقات لايف أيهما أول)

### [F] ✅ USDJPY BOJ Filter *(مطبَّق 2026-07-04)* — يوم 23 حي
- **النتيجة (backtest):** Sharpe 0.97 → 1.58 (+0.61)
- **تنبيه:** BOJ اجتماع 31 يوليو — ✅ مُختبَر 2026-07-18 — BOJ_LOWER=149 يبقى (لا تغيير)

### [I] ✅ EURUSD ADX_MIN=18 Filter *(مطبَّق 2026-07-16)* — يوم 11 حي (مراقبة مبكرة)
- **النتيجة (backtest):** Sharpe 1.706 → 1.885 (+0.179)
- **الحالة:** مراقبة مبكرة — بعد 19 يوم إضافي أو 15 صفقة لايف

### [21] FOMC Day Filter لـ EURUSD/GBPUSD *(2026-06-14)*
- **الفرضية:** تصفية الدخول قرب وقت FOMC (17:50-18:30 UTC)
- **FOMC التالي:** أغسطس 2026
- **الحالة:** 💡 فكرة قيد الدراسة — backtest مناسب للأحد (اليوم)
