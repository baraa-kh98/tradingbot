...
> آخر تحديث: 2026-07-26 (روتين صباحي — الأحد | يوم 70 نظيف ← رقم قياسي مستمر 🎉 | السوق مغلق | [A][B] 71 يوم ← رقم قياسي | [C] 75 يوم ← الأقدم | يوم 21 حي [G] 🎯 | يوم 22 حي [F] | يوم 10 حي [I] | BOJ 31 يوليو: 5 أيام)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20)* ⚡⚡⚡ ESCALATED CRITICAL — ينتظر موافقتك منذ **71 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**71 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16)* 🚨🚨🚨 CRITICAL — ينتظر موافقتك منذ **71 يوم**
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12)* ← الأقدم في تاريخ البوت كله — **75 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**75 يوم** ← **الأقدم في تاريخ البوت كله**)
...
- **الحالة:** 🔴 **متأخر 12 يوماً — عاجل قبل BOJ 31 يوليو — يحتاج تدخل يدوي على VPS**

### [G] ✅ GBPUSD — H4 RSI Filter *(مطبَّق 2026-07-05)* — يوم 21 حي 🎯
- **النتيجة (backtest):** Sharpe 1.273 → 1.664 (+0.391)
- **الحالة:** مراقبة مستمرة — مرحلة التأكيد الحرجة (15 صفقة لايف)
- **القرار المتوقع:** ~2026-08-04 (9 أيام إضافية أو 10 صفقات لايف أيهما أول)

### [F] ✅ USDJPY BOJ Filter *(مطبَّق 2026-07-04)* — يوم 22 حي
- **النتيجة (backtest):** Sharpe 0.97 → 1.58 (+0.61)
- **تنبيه:** BOJ اجتماع 31 يوليو — ✅ مُختبَر 2026-07-18 — BOJ_LOWER=149 يبقى (لا تغيير)

### [I] ✅ EURUSD ADX_MIN=18 Filter *(مطبَّق 2026-07-16)* — يوم 10 حي (مراقبة مبكرة)
- **النتيجة (backtest):** Sharpe 1.706 → 1.885 (+0.179)
- **الحالة:** مراقبة مبكرة — بعد 20 يوم إضافي أو 15 صفقة لايف
