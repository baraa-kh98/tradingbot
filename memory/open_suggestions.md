...
> آخر تحديث: 2026-06-04 (روتين صباحي — الخميس | NFP Eve | Jobless Claims ~12:30 UTC اليوم | NFP الجمعة 12:30 UTC)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 19 يوم)* ⚡⚡⚡ ESCALATED CRITICAL — **اليوم الخميس آخر فرصة قبل NFP**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**19 يوم** — **اليوم الخميس آخر فرصة قبل NFP الجمعة**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 19 يوم)* 🚨🚨🚨 CRITICAL — رقم قياسي مطلق — **اليوم الخميس آخر فرصة**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**19 يوم** ← رقم قياسي مطلق | **اليوم الخميس آخر فرصة قبل NFP**)
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 23 يوم)* ← الأقدم في تاريخ البوت كله
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**23 يوم** ← **الأقدم في تاريخ البوت كله**)
...
### [19] NFP — Non-Farm Payrolls *(2026-06-02، تحذير أسبوعي)* 🚨 **غداً**
...
- **قواعد NFP Day — لا استثناء:**
  - **لا تداول EURUSD/GBPUSD** في نافذة NY (13:00 UTC)
  - **لا تعديلات على الكود** غداً الجمعة
  - **XAUUSD:** راقب فقط إذا NFP ضعيف + VIX > 24
  - **USDJPY:** London (07:00-10:00 UTC) نافذة آمنة
- **الحالة:** 🔴 تحذير — **يُحذف بعد الجمعة 5 يونيو**
...
### [23] US Jobless Claims — اليوم الخميس *(2026-06-04)*
- **الموضوع:** Jobless Claims ~12:30 UTC — محرك USD أسبوعي — خطر على NY Window
- **الأزواج المتأثرة:** EURUSD/GBPUSD (نافذة NY 13:00 UTC بعد 30 دقيقة)
- **التوصية:** لا دخول في نافذة 12:15-12:45 UTC — انتظر 15 دقيقة بعد الصدور
