...
> آخر تحديث: 2026-06-20 (روتين صباحي — السبت | عطلة نهاية الأسبوع | يوم 35 نظيف ← رقم قياسي مطلق جديد | [A][B][C][D] UNBLOCKED — نافذة التطبيق المثالية اليوم السبت/الأحد)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 35 يوم)* ⚡⚡⚡ ESCALATED CRITICAL — **ينتظر موافقتك | السبت اليوم = نافذة التطبيق المثالية**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**35 يوم** — **السبت اليوم = نافذة التطبيق المثالية**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 35 يوم)* 🚨🚨🚨 CRITICAL — رقم قياسي مطلق جديد — **ينتظر موافقتك | السبت اليوم = نافذة التطبيق المثالية**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**35 يوم** ← رقم قياسي مطلق جديد — **السبت اليوم = نافذة التطبيق المثالية**)
...
### [19] GBPUSD Docstring قديم *(2026-06-09، 11 يوم)*
...
- **الحالة:** 📝 منخفضة الأولوية — توثيق فقط — **ينتظر موافقتك | السبت اليوم = نافذة التطبيق المثالية (دقيقتان)**

---

### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 38 يوم)* ← الأقدم في تاريخ البوت كله
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**39 يوم** ← **الأقدم في تاريخ البوت كله** | السبت اليوم = نافذة التطبيق المثالية)
...
### [22] GBPUSD Session Narrowing Analysis *(2026-06-16، 3 يوم)*
- **الخلفية:** GBPUSD Sharpe=1.270 (-0.23 من الهدف) — Parameter Tuning وصل للحد في finetune
- **الفرضية:** تضييق نافذة NY Breakout من 13:00-15:00 إلى 13:00-14:00 أو 14:00-15:00 يُحسّن جودة الإشارة
- **المنطق:** في الساعة الأولى (13:00-14:00) السيولة أعلى وأكثر اتجاهية → Breakouts أنظف
  في الساعة الثانية (14:00-15:00) أحياناً "كسر مزيف" مدفوع بـ US data
- **الاختبار:** فصل صفقات backtest حسب ساعة الدخول — هل ساعة > أخرى؟
- **وقت التنفيذ:** 20-30 دقيقة تحليل في backtest/gbpusd_research.py
- **الأولوية:** متوسطة — بعد FOMC هذا الأسبوع
- **تاريخ الاكتشاف:** 2026-06-16
