...
> آخر تحديث: 2026-07-28 (روتين صباحي — الثلاثاء | يوم 72 نظيف ← رقم قياسي مستمر 🎉 | السوق مفتوح | [A][B] 73 يوم ← رقم قياسي | [C] 77 يوم ← الأقدم | يوم 23 حي [G] 🎯 | يوم 24 حي [F] | يوم 12 حي [I] | BOJ 31 يوليو: 3 أيام 🚨🚨 | CPI متأخر 14 يوم 🔴)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20)* ⚡⚡⚡ ESCALATED CRITICAL — ينتظر موافقتك منذ **73 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**73 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16)* 🚨🚨🚨 CRITICAL — ينتظر موافقتك منذ **73 يوم**
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12)* ← الأقدم في تاريخ البوت كله — **77 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**77 يوم** ← **الأقدم في تاريخ البوت كله**)
...
- **الحالة:** 🔴 **متأخر 14 يوماً — عاجل قبل BOJ 31 يوليو (3 أيام) — يحتاج تدخل يدوي على VPS اليوم أو غداً**

### [G] ✅ GBPUSD — H4 RSI Filter *(مطبَّق 2026-07-05)* — يوم 23 حي 🎯
- **النتيجة (backtest):** Sharpe 1.273 → 1.664 (+0.391)
- **الحالة:** مراقبة مستمرة — مرحلة التأكيد الحرجة (15 صفقة لايف)
- **القرار المتوقع:** ~2026-08-04 (7 أيام إضافية أو 10 صفقات لايف أيهما أول)

### [F] ✅ USDJPY BOJ Filter *(مطبَّق 2026-07-04)* — يوم 24 حي — **الاختبار الحقيقي الأول: BOJ الخميس**
- **النتيجة (backtest):** Sharpe 0.97 → 1.58 (+0.61)
- **تنبيه:** BOJ اجتماع 31 يوليو — 3 أيام — هذا أول اختبار حقيقي للفلتر أمام حدث BOJ فعلي
- **BOJ_LOWER=149:** مُختبَر 2026-07-18 — جاهز لكل السيناريوهات ✅

### [I] ✅ EURUSD ADX_MIN=18 Filter *(مطبَّق 2026-07-16)* — يوم 12 حي (مراقبة مبكرة)
- **النتيجة (backtest):** Sharpe 1.706 → 1.885 (+0.179)
- **الحالة:** مراقبة مبكرة — بعد 18 يوم إضافي أو 15 صفقة لايف
...
### [BOJ Prep] USDJPY BOJ_LOWER طوارئ *(2026-07-31)* — ✅ مُختبَر 2026-07-18 — **3 أيام**
