...
> آخر تحديث: 2026-07-29 (روتين صباحي — الأربعاء | يوم 73 نظيف ← رقم قياسي مستمر 🎉 | السوق مفتوح | [A][B] 74 يوم ← رقم قياسي | [C] 78 يوم ← الأقدم | يوم 24 حي [G] 🎯 | يوم 25 حي [F] — **الاختبار BOJ غداً!** | يوم 13 حي [I] | BOJ 31 يوليو: **يومان** 🚨🚨🚨 | CPI متأخر **15 يوم** 🔴)

---

## 🟡 متوسطة الأولوية

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20)* ⚡⚡⚡ ESCALATED CRITICAL — ينتظر موافقتك منذ **74 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**74 يوم**)

### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16)* 🚨🚨🚨 CRITICAL — ينتظر موافقتك منذ **74 يوم**
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12)* ← الأقدم في تاريخ البوت كله — **78 يوم**
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**78 يوم** ← **الأقدم في تاريخ البوت كله**)
...
- **الحالة:** 🔴 **متأخر 15 يوماً — عاجل جداً قبل BOJ 31 يوليو (غداً الخميس) — يحتاج تدخل يدوي على VPS اليوم الأربعاء**

### [G] ✅ GBPUSD — H4 RSI Filter *(مطبَّق 2026-07-05)* — يوم 24 حي 🎯
...
### [F] ✅ USDJPY BOJ Filter *(مطبَّق 2026-07-04)* — يوم 25 حي — **🚨 الاختبار الحقيقي: BOJ غداً الخميس**
- **النتيجة (backtest):** Sharpe 0.97 → 1.58 (+0.61)
- **تنبيه:** BOJ اجتماع 31 يوليو — **غداً** — هذا أول اختبار حقيقي للفلتر أمام حدث BOJ فعلي
- **BOJ_LOWER=149:** مُختبَر 2026-07-18 — جاهز لكل السيناريوهات ✅

### [I] ✅ EURUSD ADX_MIN=18 Filter *(مطبَّق 2026-07-16)* — يوم 13 حي (مراقبة مبكرة)
...
- **ملاحظة:** BOJ الخميس سيعطي بيانات حقيقية لتقييم هذه الفكرة
- **الحالة:** 💡 فكرة جديدة — تحتاج backtest بعد BOJ

### [BOJ Prep] USDJPY BOJ_LOWER طوارئ *(2026-07-31)* — ✅ مُختبَر 2026-07-18 — **غداً 🚨🚨🚨**
...
- **الحالة:** ✅ جاهز تماماً — مراقبة يدوية الخميس مطلوبة فقط
