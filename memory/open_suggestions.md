...
> آخر تحديث: 2026-05-25 (روتين صباحي — الاثنين)

---

## 🟡 متوسطة الأولوية

### [6] XAUUSD — `_regime_check()` Exception بدون Logging *(2026-05-25، جديد اليوم)*
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم

### [4] XAUUSD — `_in_trade` check قبل `_regime_check()` *(2026-05-20، 6 أيام)*
...
### [4b] XAUUSD Regime Check — Cache مفقود *(منذ 2026-05-16، 9 أيام)*
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (**9 أيام** ← يُوصى بالتطبيق مع #4)
...
### [3] إضافة "strategy" key لكل Signal Generator *(منذ 2026-05-12، 12 يوم)*
...
- **الحالة:** ⏳ ينتظر موافقة المستخدم (13 يوم)
...
### [14] تأثير الأعياد الأمريكية على السيولة *(جديد 2026-05-25)*
- **الموضوع:** US Memorial Day اليوم — سيولة منخفضة في جلسة NY
